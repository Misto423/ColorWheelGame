...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Shane Shafferman", "LD31", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Color Wheel", null, { width: 900, height: 700 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 900, height: 700 });
			#end
