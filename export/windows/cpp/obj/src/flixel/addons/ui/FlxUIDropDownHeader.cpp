...
int Width = __o_Width.Default(120);
{
	...
	if (((this->background == null()))){
		...
		HX_STACK_LINE(426)
		::flixel::addons::ui::FlxUI9SliceSprite _g1 = ::flixel::addons::ui::FlxUI9SliceSprite_obj::__new((int)0,(int)0,HX_CSTRING("flixel/flixel-ui/img/box.png"),_g,Array_obj< int >::__new().Add((int)1).Add((int)1).Add((int)14).Add((int)14),null(),null(),null(),null(),null());		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(426)
		this->background = _g1;
	}
	HX_STACK_LINE(430)
	...
	{
		HX_STACK_LINE(441)
		::flixel::util::FlxPoint _g = this->button->offset;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(441)
	...
	{
		HX_STACK_LINE(443)
		::flixel::util::FlxPoint _g = this->button->label->__Field(HX_CSTRING("offset"),true);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(443)
