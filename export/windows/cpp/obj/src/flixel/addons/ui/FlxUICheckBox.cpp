...
Dynamic LabelW = __o_LabelW.Default(100);
{
	...
	this->button = _g1;
	HX_STACK_LINE(86)
	this->button->label->__Field(HX_CSTRING("setFormat"),true)(null(),(int)8,(int)16777215,HX_CSTRING("left"),(int)2,null(),null());
	HX_STACK_LINE(87)
	...
	HX_STACK_LINE(120)
	this->button->labelOffsets->__get((int)0).StaticCast< ::flixel::util::FlxPoint >()->set_x((int)0);
	HX_STACK_LINE(121)
	this->button->labelOffsets->__get((int)0).StaticCast< ::flixel::util::FlxPoint >()->set_y((int)0);
	HX_STACK_LINE(122)
	this->button->labelOffsets->__get((int)2).StaticCast< ::flixel::util::FlxPoint >()->set_x((int)0);
	HX_STACK_LINE(123)
	this->button->labelOffsets->__get((int)2).StaticCast< ::flixel::util::FlxPoint >()->set_y((int)0);
	HX_STACK_LINE(124)
	this->button->labelOffsets->__get((int)1).StaticCast< ::flixel::util::FlxPoint >()->set_x((int)0);
	HX_STACK_LINE(125)
	this->button->labelOffsets->__get((int)1).StaticCast< ::flixel::util::FlxPoint >()->set_y((int)0);
	HX_STACK_LINE(127)
	this->set_x(X);
	HX_STACK_LINE(128)
	this->set_y(Y);
...
{
		HX_STACK_FRAME("flixel.addons.ui.FlxUICheckBox","anchorLabelX",0xdbea9ecf,"flixel.addons.ui.FlxUICheckBox.anchorLabelX","flixel/addons/ui/FlxUICheckBox.hx",163,0xab9d9a07)
		HX_STACK_THIS(this)
		HX_STACK_LINE(163)
		if (((this->button != null()))){
			HX_STACK_LINE(164)
...
{
		HX_STACK_FRAME("flixel.addons.ui.FlxUICheckBox","anchorLabelY",0xdbea9ed0,"flixel.addons.ui.FlxUICheckBox.anchorLabelY","flixel/addons/ui/FlxUICheckBox.hx",169,0xab9d9a07)
		HX_STACK_THIS(this)
		HX_STACK_LINE(169)
		if (((this->button != null()))){
			HX_STACK_LINE(170)
...
::String FlxUICheckBox_obj::get_text( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(192)
	return this->button->label->__Field(HX_CSTRING("get_text"),true)();
}
...
Void FlxUICheckBox_obj::update( ){
{
		...
		if ((this->checkbox_dirty)){
			...
			if (((this->button->label != null()))){
				...
				this->anchorLabelY();
				HX_STACK_LINE(211)
				Float _g = this->button->label->__Field(HX_CSTRING("get_textField"),true)()->__Field(HX_CSTRING("get_textWidth"),true)();		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(211)
				Float _g1 = (this->box->frameWidth + _g);		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(211)
				Float _g2 = (_g1 + ((this->button->label->__Field(HX_CSTRING("x"),true) - ((this->button->x + this->box->frameWidth)))));		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(211)
				this->button->set_width(_g2);
				HX_STACK_LINE(212)
				this->checkbox_dirty = false;
			}
		}
