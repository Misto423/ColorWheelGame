...
Float Y = __o_Y.Default(0);
{
	...
	HX_STACK_LINE(32)
	int _g = this->down_toggle_color = (int)-1;		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(32)
	int _g1 = this->over_toggle_color = _g;		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(32)
	int _g2 = this->up_toggle_color = _g1;		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(32)
	int _g3 = this->down_color = _g2;		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(32)
	int _g4 = this->over_color = _g3;		HX_STACK_VAR(_g4,"_g4");
	HX_STACK_LINE(32)
	this->up_color = _g4;
	HX_STACK_LINE(34)
	if (((Asset != null()))){
...
Void FlxUISpriteButton_obj::autoCenterLabel( ){
{
		...
		if (((this->label != null()))){
			HX_STACK_LINE(49)
			if ((::Std_obj::is(this->label,hx::ClassOf< ::flixel::group::FlxSpriteGroup >()))){
				HX_STACK_LINE(50)
				::flixel::group::FlxSpriteGroup g = this->label;		HX_STACK_VAR(g,"g");
				HX_STACK_LINE(51)
				{
					HX_STACK_LINE(51)
