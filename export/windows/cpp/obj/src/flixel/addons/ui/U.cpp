	...
	HX_STACK_ARG(default_color,"default_color")
{
		...
		if (((return_val == (int)-1))){
			HX_STACK_LINE(317)
			::String _g1 = str.substr((int)2,(str.length - (int)2));		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(317)
			str = _g1;
			HX_STACK_LINE(318)
			if (((bool(cast32Bit) && bool((str.length == (int)6))))){
				HX_STACK_LINE(319)
				...
				while((true)){
					...
					HX_STACK_LINE(321)
					{
						...
						if (  ( _switch_3==HX_CSTRING("0")) ||  ( _switch_3==HX_CSTRING("1")) ||  ( _switch_3==HX_CSTRING("2")) ||  ( _switch_3==HX_CSTRING("3")) ||  ( _switch_3==HX_CSTRING("4")) ||  ( _switch_3==HX_CSTRING("5")) ||  ( _switch_3==HX_CSTRING("6")) ||  ( _switch_3==HX_CSTRING("7")) ||  ( _switch_3==HX_CSTRING("8")) ||  ( _switch_3==HX_CSTRING("9")) ||  ( _switch_3==HX_CSTRING("10"))){
							HX_STACK_LINE(321)
							Dynamic _g2 = ::Std_obj::parseInt(char_hex);		HX_STACK_VAR(_g2,"_g2");
							HX_STACK_LINE(321)
							val = _g2;
						}
...
Array< int > U_obj::hex2rgb( int hex){
	HX_STACK_FRAME("flixel.addons.ui.U","hex2rgb",0xeac8fe0c,"flixel.addons.ui.U.hex2rgb","flixel/addons/ui/U.hx",377,0x74647d9b)
...
int U_obj::rgb2hex( int r,int g,int b){
	HX_STACK_FRAME("flixel.addons.ui.U","rgb2hex",0xac7dff0c,"flixel.addons.ui.U.rgb2hex","flixel/addons/ui/U.hx",391,0x74647d9b)
	HX_STACK_ARG(r,"r")
	HX_STACK_ARG(g,"g")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(391)
		...
		while((true)){
			...
			HX_STACK_LINE(441)
			{
				...
				while((true)){
					...
					{
						HX_STACK_LINE(442)
						::flixel::util::FlxPoint point = ::flixel::util::FlxPoint_obj::_pool->get()->set(xx,yy);		HX_STACK_VAR(point,"point");
						HX_STACK_LINE(442)
						point->_inPool = false;
						HX_STACK_LINE(442)
						_g4 = point;
	...
	HX_STACK_ARG(dir,"dir")
{
		...
		if ((getFast)){
			HX_STACK_LINE(552)
			::Xml _g = the_xml->firstElement();		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(552)
...
Void U_obj::destroyThing( Dynamic thing){
{
		...
		if ((::Std_obj::is(thing,hx::ClassOf< Array<int> >()))){
			...
			HX_STACK_LINE(595)
			if ((::Std_obj::is(thing,hx::ClassOf< ::flixel::interfaces::IFlxDestroyable >()))){
				HX_STACK_LINE(596)
				::flixel::interfaces::IFlxDestroyable idstr;		HX_STACK_VAR(idstr,"idstr");
				HX_STACK_LINE(596)
				idstr = hx::TCast< flixel::interfaces::IFlxDestroyable >::cast(thing);
				HX_STACK_LINE(597)
				idstr->destroy();
				HX_STACK_LINE(598)
				idstr = null();
...
::String style = __o_style.Default(HX_CSTRING(""));
	HX_STACK_FRAME("flixel.addons.ui.U","fontStr",0x00b679b8,"flixel.addons.ui.U.fontStr","flixel/addons/ui/U.hx",608,0x74647d9b)
	HX_STACK_ARG(str,"str")
	...
	HX_STACK_ARG(style,"style")
{
		...
		HX_STACK_LINE(615)
		{
			...
			if (((_g1 != (int)0))){
				HX_STACK_LINE(615)
				_g2 = ((HX_CSTRING("assets/fonts/") + str) + suffix);
			}
			else{
				HX_STACK_LINE(615)
				_g2 = (str + suffix);
...
::flixel::addons::ui::FlxUISprite U_obj::fsx( Dynamic data){
	HX_STACK_FRAME("flixel.addons.ui.U","fsx",0x630af321,"flixel.addons.ui.U.fsx","flixel/addons/ui/U.hx",636,0x74647d9b)
	HX_STACK_ARG(data,"data")
	HX_STACK_LINE(636)
...
::flixel::FlxSprite U_obj::fs( Dynamic data){
	HX_STACK_FRAME("flixel.addons.ui.U","fs",0x12cfd577,"flixel.addons.ui.U.fs","flixel/addons/ui/U.hx",640,0x74647d9b)
	HX_STACK_ARG(data,"data")
	HX_STACK_LINE(640)
				...
				while((true)){
					...
					if (((c == (int)0))){
						...
						if (((c == (w - (int)1)))){
							...
							if (((last_p != (int)-1))){
								HX_STACK_LINE(868)
								hx::AddEq(csv,(HX_CSTRING(", ") + last_p));
							}
						}
					}
					HX_STACK_LINE(872)
...
::String U_obj::get_gfx( ::String str){
	...
	struct _Function_1_1{
		inline static bool Block( ::String &str){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/addons/ui/U.hx",879,0x74647d9b)
			{
				HX_STACK_LINE(879)
				int _g1 = str.indexOf(HX_CSTRING("RAW:"),null());		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(879)
				return (_g1 == (int)0);
			}
			return null();
	...
	HX_STACK_LINE(879)
	if (((  ((!(((_g == (int)0))))) ? bool(_Function_1_1::Block(str)) : bool(true) ))){
		HX_STACK_LINE(880)
		::String _g2 = str.substr((int)4,(str.length - (int)4));		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(880)
		str = _g2;
		HX_STACK_LINE(881)
...
::flixel::util::FlxPoint U_obj::obj_direction( ::flixel::FlxObject a,::flixel::FlxObject b){
	...
	HX_STACK_LINE(989)
	::flixel::util::FlxPoint ipt;		HX_STACK_VAR(ipt,"ipt");
	HX_STACK_LINE(989)
	{
		HX_STACK_LINE(989)
	...
	HX_STACK_LINE(1245)
	{
		...
		while((true)){
			...
			struct _Function_3_1{
				inline static bool Block( ::String &str){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/addons/ui/U.hx",1252,0x74647d9b)
					{
						HX_STACK_LINE(1252)
			...
			if (((  (((_g21 == HX_CSTRING("<")))) ? bool(_Function_3_1::Block(str)) : bool(false) ))){
				...
				struct _Function_4_1{
					inline static bool Block( ::String &str){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/addons/ui/U.hx",1258,0x74647d9b)
						{
							HX_STACK_LINE(1258)
