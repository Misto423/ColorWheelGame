...
Void FlxUIInputText_obj::onChange( ::String action){
{
		...
		if ((this->broadcastToFlxUI)){
			...
			if (  ( _switch_1==HX_CSTRING("enter"))){
				...
				HX_STACK_LINE(34)
				::flixel::addons::ui::FlxUI_obj::event(HX_CSTRING("enter_input_text"),hx::ObjectPtr<OBJ_>(this),_g,null());
			}
			else if (  ( _switch_1==HX_CSTRING("delete")) ||  ( _switch_1==HX_CSTRING("backspace"))){
				HX_STACK_LINE(37)
				::String _g1 = this->get_text();		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(37)
				::flixel::addons::ui::FlxUI_obj::event(HX_CSTRING("delete_input_text"),hx::ObjectPtr<OBJ_>(this),_g1,null());
				HX_STACK_LINE(38)
				::String _g2 = this->get_text();		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(38)
				::flixel::addons::ui::FlxUI_obj::event(HX_CSTRING("change_input_text"),hx::ObjectPtr<OBJ_>(this),_g2,null());
			}
			else if (  ( _switch_1==HX_CSTRING("input"))){
				HX_STACK_LINE(40)
				::String _g3 = this->get_text();		HX_STACK_VAR(_g3,"_g3");
				HX_STACK_LINE(40)
				::flixel::addons::ui::FlxUI_obj::event(HX_CSTRING("input_input_text"),hx::ObjectPtr<OBJ_>(this),_g3,null());
				HX_STACK_LINE(41)
				::String _g4 = this->get_text();		HX_STACK_VAR(_g4,"_g4");
				HX_STACK_LINE(41)
				::flixel::addons::ui::FlxUI_obj::event(HX_CSTRING("change_input_text"),hx::ObjectPtr<OBJ_>(this),_g4,null());
			}
		}
	}
return null();
