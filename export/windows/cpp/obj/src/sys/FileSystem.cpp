...
Dynamic FileSystem_obj::stat( ::String path){
	HX_STACK_FRAME("sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","C:\\Users\\Shane\\Downloads\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",42,0x4bb1a5ad)
	...
	if (((s == null()))){
		...
		struct _Function_2_1{
			inline static Dynamic Block( ::Date &_g1,::Date &_g,::Date &_g2){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\Users\\Shane\\Downloads\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",45,0x4bb1a5ad)
				{
...
::String FileSystem_obj::fullPath( ::String relPath){
	HX_STACK_FRAME("sys.FileSystem","fullPath",0xc6463316,"sys.FileSystem.fullPath","C:\\Users\\Shane\\Downloads\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",52,0x4bb1a5ad)
...
{
		HX_STACK_FRAME("sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","C:\\Users\\Shane\\Downloads\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",69,0x4bb1a5ad)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(70)
			...
			while((true)){
				...
				struct _Function_3_1{
					inline static bool Block( ::String &part){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\Users\\Shane\\Downloads\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",74,0x4bb1a5ad)
						{
							HX_STACK_LINE(74)
...
{
		HX_STACK_FRAME("sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","C:\\Users\\Shane\\Downloads\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",79,0x4bb1a5ad)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(80)
