...
class HXCPP_CLASS_ATTRIBUTES  FlxUITabMenu_obj : public ::flixel::addons::ui::FlxUIGroup_obj{
	public:
		...
		FlxUITabMenu_obj();
		Void __construct(::flixel::FlxSprite back_,Array< ::Dynamic > tabs_,Dynamic tab_ids_and_labels_,::flixel::util::FlxPoint tab_offset,Dynamic __o_stretch_tabs,Dynamic tab_spacing,Array< ::String > tab_stacking);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< FlxUITabMenu_obj > __new(::flixel::FlxSprite back_,Array< ::Dynamic > tabs_,Dynamic tab_ids_and_labels_,::flixel::util::FlxPoint tab_offset,Dynamic __o_stretch_tabs,Dynamic tab_spacing,Array< ::String > tab_stacking);
